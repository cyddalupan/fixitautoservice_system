...
<head>
    ...
    <title>Repair Order Slip — {{ $appointment->appointment_number }}</title>
    <style>
...
<body>
    <div class="toolbar">
        <a href="{{ route('appointments.update-info.form', $appointment) }}" class="btn btn-back">&larr; Back to Update Info</a>
        <div class="actions">
            <a href="{{ route('appointments.repair-order.pdf', $appointment) }}" class="btn btn-pdf">&#11015; Download PDF</a>
