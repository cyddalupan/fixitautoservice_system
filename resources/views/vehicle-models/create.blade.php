            ...
            <form action="{{ route('vehicle-models.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="year_start" id="year_start" class="form-control @error('year_start') is-invalid @enderror" value="{{ old('year_start') }}" min="1900" max="{{ date('Y') + 1 }}">
                        @error('year_start') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="year_end" class="form-label">Year End</label>
                        <input type="number" name="year_end" id="year_end" class="form-control @error('year_end') is-invalid @enderror" value="{{ old('year_end') }}" min="1900" max="{{ date('Y') + 1 }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="body_type" id="body_type" class="form-select @error('body_type') is-invalid @enderror">
                            ...
                            <option value="Bus" {{ old('body_type') == 'Bus' ? 'selected' : '' }}>Bus</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="vehicle_type" id="vehicle_type" class="form-select @error('vehicle_type') is-invalid @enderror">
                            ...
                            <option value="Off-road" {{ old('vehicle_type') == 'Off-road' ? 'selected' : '' }}>Off-road</option>
                            <option value="Sports" {{ old('vehicle_type') == 'Sports' ? 'selected' : '' }}>Sports</option>
                        </select>
