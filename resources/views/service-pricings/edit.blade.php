...
<div class="container-fluid px-4 py-3">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0"><i class="fas fa-edit me-2 text-primary"></i>Edit Service Pricing</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('service-pricings.update', $servicePricing) }}">
                @csrf @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="service_type_id" class="form-select @error('service_type_id') is-invalid @enderror" required>
                            ...
                            @foreach($serviceTypes as $st)
                                <option value="{{ $st->id }}" {{ old('service_type_id', $servicePricing->service_type_id) == $st->id ? 'selected' : '' }}>
                                    {{ $st->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="brand_name" class="form-control @error('brand_name') is-invalid @enderror"
                               value="{{ old('brand_name', $servicePricing->brand_name) }}" placeholder="e.g. Toyota, Honda, Mitsubishi">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="model_name" class="form-control @error('model_name') is-invalid @enderror"
                               value="{{ old('model_name', $servicePricing->model_name) }}" placeholder="e.g. Vios, Civic, Montero">
                        <small class="text-muted">Optional — manual input</small>
                        @error('model_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="variant_label" class="form-control @error('variant_label') is-invalid @enderror"
                               value="{{ old('variant_label', $servicePricing->variant_label) }}"
                               placeholder="e.g. Single AC, 3L Oil, Standard">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="price"
                                   ...
                                   value="{{ old('price', $servicePricing->price) }}" placeholder="0.00" required>
                        </div>
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" min="0" name="sort_order"
                               ...
                               value="{{ old('sort_order', $servicePricing->sort_order ?? 0) }}">
                        @error('sort_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="is_active" class="form-check-input" value="1" id="isActive" {{ old('is_active', $servicePricing->is_active) ? 'checked' : '' }}>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="2"
                                  placeholder="Any additional info about this pricing...">{{ old('notes', $servicePricing->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
